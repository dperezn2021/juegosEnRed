var tutorialScene = new Phaser.Class({
    ...
    preload: function() {
        ...
        this.load.image('grass1','assets/Tutorial/bloques/hierbas/h1.png');
        this.load.image('grass2','assets/Tutorial/bloques/hierbas/h2.png');
        this.load.image('grass3','assets/Tutorial/bloques/hierbas/h3.png');
        this.load.image('grass4','assets/Tutorial/bloques/hierbas/h4.png');
        this.load.image('grass5','assets/Tutorial/bloques/hierbas/h5.png');
        //Carteles
        ...
        this.load.audio('dano', 'assets/Sonidos/dano.mp3');
    ...
    create: function() {
        ...
        this.add.image(331.5, 777, 'grass1');
        this.add.image(957, 688, 'grass2');
        this.add.image(1990.5, 876, 'grass3');
        this.add.image(2749, 978, 'grass4');
        this.add.image(3713, 671, 'grass5');
        ...
        dano = this.sound.add('dano', {volume: 0.3});
